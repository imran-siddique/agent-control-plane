...
% NOTE: arXiv does NOT accept anonymous submissions!
% UPDATE the author information below before submitting.
...
% TODO: Replace with your real name and affiliation before arXiv submission
% Format: Firstname Lastname (Affiliation)
% Example: Imran Siddique (Microsoft)
\author{[UPDATE BEFORE SUBMISSION]\\
[Your Affiliation]\\
...
Ablation studies with statistical rigor (Welch's t-test, Bonferroni correction) confirm component necessity: removing the \textit{PolicyEngine} increases violations from 0\% to 40.0\% ($p < 0.0001$, Cohen's $d = 8.7$). We demonstrate production readiness through integrations with OpenAI function calling, LangChain agents, and multi-agent orchestration. Code is available at \url{https://github.com/[UPDATE-USERNAME]/agent-control-plane}.
\end{abstract}
...
% ============================================================================
% Bibliography - Using pre-compiled .bbl for arXiv submission
% ============================================================================
...
# Clone repository
git clone https://github.com/[UPDATE-USERNAME]/agent-control-plane.git
