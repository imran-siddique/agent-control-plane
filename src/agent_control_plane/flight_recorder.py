...
class FlightRecorder:
    ...
    def start_trace(self, agent_id: str, tool_name: str, tool_args: Optional[Dict[str, Any]] = None, 
    ...
    def log_success(self, trace_id: str, result: Optional[Any] = None, 
        ...
        result_str = json.dumps(result) if result and not isinstance(result, str) else str(result) if result else None
    ...
    def query_logs(self, agent_id: Optional[str] = None, 
